...
<head>
    ...
    <meta name="viewport" content=scale=1.0, maximum-scale=1.0, user-scalable=0" />
    <title><?php echo PAGE_TITLE; ?> - Spare Mapping List</title>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dataTable = $('#spareTable').DataTable({
                ...
                'ajax': {
                    'url': 'inc/datatable/ajaxMappingList.php',
                    'data': function(data) {
                        // Read values
            ...
            $('#spareTable').on('click', 'a.delete', function(e) {
                e.preventDefault();
                if (confirm("Are you sure, you want to delete this Supplier?")) {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            //alert(result);
                            if (result > 0) {
                                $('#spareTable').dataTable().fnDeleteRow(nRow);
                                $.jGrowl('Spare deleted..!', {
                                    sticky: false,
                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <span class="breadcrumb-item active">Spare Mapping List</span>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-pgheader text-white header-elements-inline">
                                <h6 class="card-title">Spare Mapping List</h6>
                                ...
                                <div class="form-group row pl-2">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Item Code / Category / Description </label>
                                            <input type='text' class="form-control" id='searchByCode' name="searchByCode" placeholder='Item Code / Category / Description'>
                                        </div>
                                    </div>

                                </div>
                                <hr class="mt-0 mb-1">
                                <table class="table table-xs table-hover table-bordered mt-0" id="spareTable">
                                    <thead>
                                        <tr class="bg-table-header">
                                            <th>#</th>
                                            <th>Sale Item Code</th>
                                            <th>Purchase/Mfg Code</th>
                                            <th>Division</th>
                                            <th>Description</th>
                                            <th>Spare Mapped</th>
                                            <th>Actions</th>
