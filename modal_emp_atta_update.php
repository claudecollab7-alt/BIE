...
<div id="modalEmplyeeAttendanceupdate" class="modal fade" tabindex="-1">
		<div class="modal-dialog   modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header pb-2 pt-2 bg-modal">
					<h6 class="modal-title" style="width: 800px;">
	</span><span id="m_sales_re" class="font-weight-bold"></span></h6>
			...
			<div class="modal-body py-0" id="m_sales_cod">				
