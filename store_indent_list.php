...
<head>
    ...
    <title><?php echo PAGE_TITLE; ?> - Store Indent List</title>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var dataTable = $('#siTable').DataTable({
                ...
                'ajax': {
                    'url': 'inc/datatable/ajax_SiList.php',
                    'data': function(data) {
                        // Read values
                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <span class="breadcrumb-item active">Store Indent List</span>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-pgheader text-white header-elements-inline">
                                <h6 class="card-title">List of Store Indent</h6>
