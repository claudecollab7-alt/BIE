                                   ...
                                   // $to_dt = date("Y-m-d", strtotime($_REQUEST['to_dt']));
                                    ...
                                    echo '<div id="stock_division">
									  <div class="col-md-12 text-center">	
											<span class="font-size-lg font-weight-semibold text-uppercase">Stock List as on '. date('d-m-Y H:i').'</span><br>
											<b>
                                            Item Type:'.$Itemname.'
                                    ...
                                    echo '<table class="table table-xs invoice_tbl" id="stock_db_table">
                                     ...
                                     $SQL = "SELECT *  FROM tbl_item_details as a 
                                    ...
                                    if ($result->rowCount() > 0) {
                                        ...
                                        while ($obj = $result->fetch()) {
                                           ...
                                           // $total = ((int)$obj->trans_qty * (int)$obj->item_price);
                                            echo '<tr ' . $color . '>
													<td>' . $Sno . '</td>
													<td align="center">' .$obj->item_code .'/'.$obj->item_purchase_code. '</td>
                                                   
													<td align="left">' . $name . '</td>
													<td align="center">' . $uomname . '</td>
													<td align="left">' . $obj->category_name . '</td>
													<td>' . $obj->item_curr_stock . '</td>
