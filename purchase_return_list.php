...
<title><?php echo PAGE_TITLE; ?> - Purchase Return List</title>
...
var dataTable = $('#grn_table').DataTable({
                ...
                'ajax': {
                    'url': 'inc/datatable/ajaxPurchaseReturnList.php',
                    'data': function(data) {
                        // Read values
                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <span class="breadcrumb-item active">Purchase Return List </span>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-pgheader text-white header-elements-inline">
                                <h6 class="card-title">List of Purchase Return </h6>
                            </div>
				                ...
				                <div class="form-group row pl-2">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Search </label>
                                            <input type='text' class="form-control" id='searchByCode' name="searchByCode" placeholder='Enter Purchase Return No. / Supplier Name'>
                                        </div>
                                    </div>
