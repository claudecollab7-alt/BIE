                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <span class="breadcrumb-item active">Employee Salary Setting</span>
                        </div>
                                ...
                                <div class="form-group row pl-2">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Search</label>
                                            <input type='text' class="form-control" id='search_salary' name="search_salary" placeholder='Enter Employee Name / Employee Code'>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#emp_sal').DataTable({
            ...
            'ajax': {
                'url': 'inc/datatable/ajaxEmployeeSalarySet.php',
                'data': function(data) {
