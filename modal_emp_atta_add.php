...
<div id="modalEmplyeeAttendanceAdd" class="modal fade" tabindex="-1">
		<div class="modal-dialog   modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header pb-2 pt-2 bg-modal">
					<h6 class="modal-title" style="width: 800px;">
	</span><span id="emp_atte_form" class="font-weight-bold"></span></h6>
			...
			<div class="modal-body py-0" id="emp_det">				
