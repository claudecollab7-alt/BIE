                                ...
                                <div class="form-group row pl-2">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Search</label>
                                            <input type='text' class="form-control" id='search_emp_adv' name="search_emp_adv" placeholder='Enter Employee Code / Employee Name'>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#emp_sal').DataTable({
            ...
            'ajax': {
                'url': 'inc/datatable/ajaxEmployeeAdvance.php',
                'data': function(data) {


                    var search_emp_adv = $('#search_emp_adv').val();
                    ...
                    data.search_emp_adv = search_emp_adv;
                }
            },
