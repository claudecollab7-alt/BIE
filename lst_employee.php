...
<head>
    ...
    <title>
        <?php echo PAGE_TITLE; ?> - Employee List
    </title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-pgheader text-white header-elements-inline">
                                <h6 class="card-title">List of Employee</h6>
                                ...
                                <div class="form-group row pl-2">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Search</label>
                                            <input type='text' class="form-control" id='search_employee_dets' name="search_employee_dets" placeholder="Enter  Code /  Name /  Mobile No.">
                                        </div>
                                    </div>
                                    ...
                                    <?php if ($_SESSION['_user_branch'] == 1) { ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <script>
                                                    document.getElementById('searchByEmployeeType').value = "<?php echo $searchByEmployeeType; ?>";
                                                </script>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <script>
                                                    document.getElementById('searchByDepartment').value = "<?php echo $searchByDepartment; ?>";
                                                </script>
                                            </div>
                                        </div>
                                        <div class="col-md-3 pt-2">
                                            <div class="form-group">
                                                ...
                                                <script>
                                                    document.getElementById('searchByDesignation').value = "<?php echo $searchByDesignation; ?>";
                                                </script>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#emp_list').DataTable({
            ...
            'ajax': {
                'url': 'inc/datatable/ajaxEmployeeList.php',
                'data': function(data) {


                    var search_employee_dets = $('#search_employee_dets').val();
                    ...
                    data.search_employee_dets = search_employee_dets;
        ...
        $('#search_employee_dets').keyup(function() {
            dataTable.draw();
        });
        ...
        if (confirm("Are you sure, you want to delete this Employee?")) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    // alert(result);
                    window.location.href = "lst_employee.php";
