...
if(isset($_REQUEST['id']) )
{
	...
	{
		$item_max_qty = $obj->item_max_qty;$obj = $result->fetch(PDO::FETCH_OBJ);
		...
		if($obj->item_max_qty=='') $item_max_qty = '-'; else $item_max_qty = $obj->item_max_qty;
		if($obj->item_order_min_qty=='') $item_order_min_qty = '-'; else $item_order_min_qty = $obj->item_order_min_qty;
		if($obj->item_min_qty=='') $item_min_qty = '-'; else $item_min_qty = $obj->item_min_qty;
		if($obj->item_cost_price=='') $item_cost_price = '-'; else $item_cost_price = $obj->item_cost_price;
		if($obj->item_selling_price=='') $item_selling_price = '-'; else $item_selling_price = $obj->item_selling_price;
