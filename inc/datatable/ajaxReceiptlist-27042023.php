...
while ($row = $cusRecords->fetch()) {
    ...
    // elseif($row->so_verify_status == 1 && $row->pay_status == 1){
    //     $pay_link = '<a href="javascript:;" data-popup="tooltip" title="Pay Receipt"><i class="fa fa-rupee mr-2 bg-edit-disabled" style="font-size:16px"></i></a>';
    // }
