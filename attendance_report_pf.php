...
if (isset($_POST['GET_ATTN'])) {
    header("location:attendance_report_pf.php?month_id=" . $_REQUEST['month_id'] . "&atten_year=" . $_REQUEST['atten_year'] . "&emp_id=" . $_REQUEST['emp_id']);
    die();
}
            ...
            <div class="content pt-0">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form name="thisform" class="form-horizontal" method='POST' action="attendance_report_pf.php" onSubmit="return fnValidate();" enctype="multipart/form-data">
                            <?php
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php if (isset($_REQUEST['month_id']) && $_REQUEST['month_id'] != '') { ?>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                $SQL = "SELECT * FROM mst_employee WHERE bio_id > 0 AND  rec_del_status = 1 AND emp_pf = 2 ORDER BY bio_id ASC";
                                                    ...
                                                    while ($obj = $result->fetch()) {
                                                        ...
                                                        if ($result1->rowCount() > 0) {
                                                            ...
                                                            if ($salary_calc[5] == 2) {
                                                                ...
                                                                $earned_salary  = ($emp_ctc * $paid_days);
                                                            }
                                                            ...
                                                            $net_amount = ($earned_salary - $epf_amount - $payment_amount - $debit_payment_amount);
                                                            $return_payment_link = '';
                                                            $debit_payment_link = '';
                                                            $return_payment = 0;
                                                            ...
                                                            if ($balance_amount > 0 && $balance_amount > $payment_amount) {

                                                                if ($payment_amount > 0) {
                                                                    $return_payment_link = $payment_amount;
                                                                    $return_payment = $payment_amount;
                                                                } else {
                                                                    $return_payment_link = '<a href="emp_advance_return_payment.php?id=' . $obj->emp_id . '&atten_month=' . $_REQUEST['month_id'] . '&atten_year=' . $_REQUEST['atten_year'] . '&net=' . $net_amount . '&page=pf" class="tip label label-success" title="Advance Deduction">+</a>';
                                                                }
                                                            } else {
                                                                if ($payment_amount > 0) {
                                                                    $return_payment_link = $payment_amount;
                                                            ...
                                                            /*debit*/
                                                            if ($balance_debit_amount > 0 && $balance_debit_amount > $debit_payment_amount) {
                                                                ...
                                                                if ($debit_payment_amount > 0) {
                                                                    ...
                                                                    $debit_payment_link = '<a href="emp_debit_return_payment.php?id=' . $obj->emp_id . '&atten_month=' . $_REQUEST['month_id'] . '&atten_year=' . $_REQUEST['atten_year'] . '&net=' . $net_amount . '&page=pf" class="tip label label-success" title="debit Deduction">+</a>';

                                                                    // $debit_payment_link = '<a href="emp_debit_note.php?emp_id='.$obj->emp_id. '" data-month='.$_REQUEST['month_id'].' class="badge bg-info" title="" data-original-title="Modify Debit">Modify Debit</a>';
                                                            ...
                                                            if ($_SESSION['_user_id'] == 1) {
                                                                // $issueBtn = '<input type="button" name="issue_salary" value = "Issue" class="issue_salary btn btn-primary" />';
                                                            ...
                                                            $issued_salary = $dbconn->GetSingleReconrd("tbl_emp_monthly_salary", "emp_sal_id", "salary_status = 1 AND salary_for = '" . $_REQUEST['atten_year'] . '-' . $_REQUEST['month_id'] . "' AND salary_type = 'WPF' AND  emp_id", $obj->emp_id);
                                                            ...
                                                            <table class="table table-xs invoice_tbl">
                                                                <tbody>
                                                                    ...
                                                                    <tr     >
                                                                        ...
                                                                        <td colspan="18">
                                                                            <p align="right">
                                                                                <b>BENZEAR EQUIPMENTS INDIA (P) LTD</b><br />
                                                                                COIMBATORE - 35<br />
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <input type="hidden" class="fh_days" name="fh_days" value="<?php echo $function_holidays; ?>" />
                                                                        ...
                                                                        <input type="hidden" class="epf_amount" name="epf_amount" value="<?php echo $epf_amount; ?>" />
                                                                        <input type="hidden" class="advance_amount" name="advance_amount" value="<?php echo $advance_amount; ?>" />
                                                                        ...
                                                                        <td><?php echo $function_holidays ?></td>
                                                                        <td><?php echo $days ?></td>
                                                                        ...
                                                                        <td><?php echo number_format($epf_amount, 2) ?></td>
                                                                        ...
                                                                        <td class="text-center md-1 "><?php echo $issueBtn ?><?php echo $checkAttendance ?></td>
                                                                    </tr>
