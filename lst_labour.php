...
<head>
    ...
    <title>
        <?php echo PAGE_TITLE; ?> - Labour List
    </title>
                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <span class="breadcrumb-item active">Labour List</span>
                        </div>
                                ...
                                <div class="form-group row pl-2">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Search</label>
                                            <input type='text' class="form-control" id='search_labour_dets' name="search_labour_dets" placeholder='Enter Labour Code/Labour Name/Labour Mobile No.'>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('#emp_list').DataTable({
            ...
            'ajax': {
                'url': 'inc/datatable/ajaxLabourList.php',
                'data': function(data) {


                    var search_labour_dets = $('#search_labour_dets').val();
                    ...
                    data.search_labour_dets = search_labour_dets;
        ...
        $('#search_labour_dets').keyup(function() {
            dataTable.draw();
        });
        ...
        if (confirm("Are you sure, you want to delete this Employee?")) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    // alert(result);
                    window.location.href = "lst_labour.php";
